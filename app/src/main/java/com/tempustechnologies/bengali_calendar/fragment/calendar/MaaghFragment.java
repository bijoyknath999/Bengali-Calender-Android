...
import com.tempustechnologies.bengali_calendar.databinding.FragmentMaaghBinding;
...
public class MaaghFragment extends Fragment {

    private FragmentMaaghBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMaaghBinding.inflate(getLayoutInflater());
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        calViewModel.getCalendarDataList("10", getContext()).observe(getActivity(), new Observer<List<CalendarData>>() {
            @Override
