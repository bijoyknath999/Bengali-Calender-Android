...
import com.tempustechnologies.bengali_calendar.databinding.FragmentChaitraBinding;
...
public class ChaitraFragment extends Fragment {

    private FragmentChaitraBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentChaitraBinding.inflate(getLayoutInflater());
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        calViewModel.getCalendarDataList("12", getContext()).observe(getActivity(), new Observer<List<CalendarData>>() {
            @Override
