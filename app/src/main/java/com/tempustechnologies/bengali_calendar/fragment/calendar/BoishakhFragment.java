...
import com.tempustechnologies.bengali_calendar.databinding.FragmentBoishakhBinding;
...
public class BoishakhFragment extends Fragment {

    private GridLayoutManager gridLayoutManager;
    private List<CalendarData> calendarDataList;
    private CalendarAdapters calendarAdapters;
    private FragmentBoishakhBinding binding;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        binding = FragmentBoishakhBinding.inflate(getLayoutInflater());
        ...
        calViewModel.getCalendarDataList("1", getContext()).observe(getActivity(), new Observer<List<CalendarData>>() {
            @Override
