...
public class AasharFragment extends Fragment {
    private GridLayoutManager gridLayoutManager;
    private List<CalendarData> calendarDataList;
    private CalendarAdapters calendarAdapters;
    private FragmentAasharBinding binding;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        binding = FragmentAasharBinding.inflate(getLayoutInflater());
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        calViewModel.getCalendarDataList("3", getContext()).observe(getActivity(), new Observer<List<CalendarData>>() {
            @Override
