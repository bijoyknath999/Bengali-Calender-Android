...
import com.tempustechnologies.bengali_calendar.databinding.FragmentPoushBinding;
...
public class PoushFragment extends Fragment {

    private FragmentPoushBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentPoushBinding.inflate(getLayoutInflater());
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        calViewModel.getCalendarDataList("9", getContext()).observe(getActivity(), new Observer<List<CalendarData>>() {
            @Override
