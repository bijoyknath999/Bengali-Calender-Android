...
import com.tempustechnologies.bengali_calendar.databinding.FragmentAgrahanBinding;
...
public class AgrahanFragment extends Fragment {

    private FragmentAgrahanBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAgrahanBinding.inflate(getLayoutInflater());
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        calViewModel.getCalendarDataList("8", getContext()).observe(getActivity(), new Observer<List<CalendarData>>() {
            @Override
