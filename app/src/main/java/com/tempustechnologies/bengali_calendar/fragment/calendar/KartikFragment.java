...
import com.tempustechnologies.bengali_calendar.databinding.FragmentKartikBinding;
...
public class KartikFragment extends Fragment {
    ...
    private FragmentKartikBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentKartikBinding.inflate(getLayoutInflater());
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        calViewModel.getCalendarDataList("7", getContext()).observe(getActivity(), new Observer<List<CalendarData>>() {
            @Override
