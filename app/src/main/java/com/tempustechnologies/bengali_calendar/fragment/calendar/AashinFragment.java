...
import com.tempustechnologies.bengali_calendar.databinding.FragmentAasharBinding;
import com.tempustechnologies.bengali_calendar.databinding.FragmentAashinBinding;
...
public class AashinFragment extends Fragment {

    private GridLayoutManager gridLayoutManager;
    private List<CalendarData> calendarDataList;
    private CalendarAdapters calendarAdapters;
    private FragmentAashinBinding binding;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        binding = FragmentAashinBinding.inflate(getLayoutInflater());
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        calViewModel.getCalendarDataList("6", getContext()).observe(getActivity(), new Observer<List<CalendarData>>() {
            @Override
