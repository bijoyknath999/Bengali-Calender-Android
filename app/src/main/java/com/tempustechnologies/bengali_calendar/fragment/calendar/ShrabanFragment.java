...
import com.tempustechnologies.bengali_calendar.databinding.FragmentShrabanBinding;
...
public class ShrabanFragment extends Fragment {

    private FragmentShrabanBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentShrabanBinding.inflate(getLayoutInflater());
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        calViewModel.getCalendarDataList("4", getContext()).observe(getActivity(), new Observer<List<CalendarData>>() {
            @Override
