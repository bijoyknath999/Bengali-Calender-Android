...
import com.tempustechnologies.bengali_calendar.databinding.FragmentJaisthoBinding;
...
public class JaisthoFragment extends Fragment {

    private GridLayoutManager gridLayoutManager;
    private List<CalendarData> calendarDataList;
    private CalendarAdapters calendarAdapters;
    private FragmentJaisthoBinding binding;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        binding = FragmentJaisthoBinding.inflate(getLayoutInflater());
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        calViewModel.getCalendarDataList("2", getContext()).observe(getActivity(), new Observer<List<CalendarData>>() {
            @Override
