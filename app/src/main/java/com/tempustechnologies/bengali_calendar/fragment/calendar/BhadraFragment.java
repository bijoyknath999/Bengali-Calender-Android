...
import com.tempustechnologies.bengali_calendar.databinding.FragmentBhadraBinding;
...
public class BhadraFragment extends Fragment {

    private FragmentBhadraBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBhadraBinding.inflate(getLayoutInflater());
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        calViewModel.getCalendarDataList("5", getContext()).observe(getActivity(), new Observer<List<CalendarData>>() {
            @Override
